    ...
    <nav class="navbar navbar-expand-md py-3" style="background: rgb(255,197,158);border-right: 0px hidden rgba(255,255,255,0) ;">
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center"><img src="assets/img/logo.svg"><span style="font-family: Ubuntu, sans-serif;font-weight: bold;font-size: 24px;">FURCO</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-2"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse justify-content-center" id="navcol-2">
                ...
                </ul><a class="btn btn-primary d-flex justify-content-center align-items-center ms-md-2" role="button" href="register.html" style="background: #ff8e3c;font-family: Roboto, sans-serif;width: 114px;height: 43px;border-color: rgba(255,255,255,0);border-radius: 22px;box-shadow: 0px 5px 10px 0px rgb(0,0,0);">Sign Up</a>
            </div>
        </div>
    </nav>
            ...
            <div class="card d-grid mb-5" style="width: 637px;height: 417px;border-radius: 19px;background: #ffffff00;">
                <div class="card-body" style="background: #f9c180;width: 637px;height: 417px;border-radius: 19px;box-shadow: 0px 5px 10px;">
                    ...
                    <form class="text-center">
                        <div class="mb-3"><input class="form-control-plaintext" type="text" value="Email Address *" readonly="" style="font-weight: bold;font-family: Poppins, sans-serif;font-size: 14px;"><input class="form-control" type="email" name="email" style="border-radius: 22px;font-family: Poppins, sans-serif;" required=""></div>
                        <div class="mb-3"><input class="form-control-plaintext" type="text" value="Password *" readonly="" style="font-size: 14px;font-family: Poppins, sans-serif;font-weight: bold;"><input class="form-control" type="password" name="password" style="border-radius: 22px;font-family: Poppins, sans-serif;" required=""></div>
                        <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: #ff8e3c;font-family: Poppins, sans-serif;font-size: 14px;border-radius: 22px;border-color: #ffffff00;color: rgb(0,0,0);font-weight: bold;">Login</button></div>
                        <p class="text-muted" style="font-family: Poppins, sans-serif;font-size: 14px;">Don't have an account? <a href="register.html"><strong>Sign Up</strong></a></p>
                    </form>
                </div>
            </div>
        </div>
