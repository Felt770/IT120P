...
if (isset($_POST['register_btn'])) {
    ...
    $registrationSuccess = registerUser($email, $password, $fullName, $phoneNumber);
    ...
    if ($registrationSuccess) {
        ...
        $errorMessage = isset($_SESSION['error']) ? $_SESSION['error'] : 'Registration failed due to an unknown error.';
    }
}

function registerUser($email, $password, $fullName, $phoneNumber) {
    // Include registration logic here, make sure to return true/false based on success/failure
    $conn = db_connect(); // Assumes db_connect() sets up a database connection
